...
- (void)drawRect:(CGRect)rect {
    ...
    if (self.type == HMSegmentedControlTypeText) {
        [self.sectionTitles enumerateObjectsUsingBlock:^(id titleString, NSUInteger idx, BOOL *stop) {
            ...
            stringHeight = self.segmentWidthStyle == HMSegmentedControlSegmentWidthStyleDynamic ? [self bounds].size.height : size.height;
            ...
            if (self.segmentWidthStyle == HMSegmentedControlSegmentWidthStyleFixed) {
                ...
                UIColor *titleColor = titleAttrs[NSForegroundColorAttributeName];
                UIFont *fontColor = titleAttrs[NSFontAttributeName];

                label.text = [[self attributedTitleAtIndex:idx] string];
                label.textColor = titleColor;
                label.font = fontColor;
...
- (void)updateSegmentsRects {
    ...
    if (self.type == HMSegmentedControlTypeText && self.segmentWidthStyle == HMSegmentedControlSegmentWidthStyleFixed) {
        ...
        [self.sectionTitles enumerateObjectsUsingBlock:^(id titleString, NSUInteger idx, BOOL *stop) {
            CGFloat stringWidth = 130 + self.segmentEdgeInset.left + self.segmentEdgeInset.right;
